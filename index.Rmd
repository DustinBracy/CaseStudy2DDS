...
nbArray <- c("EducationField",'HighlySatisfied','OverTime','LowLevel','Unbalanced', "JobRole", "WorkedOver30",'MaritalStatus','JobInvolvement',"SalaryHike", "NewHire","NewWorker","NewToRole", "AgeUnder40","DueForPromotion","TopPerformer","NoStock","Gender")
